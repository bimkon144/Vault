...
// параметры данной стратегии, пока не активно
...
contract Stratery is StrategyInterface{
    ...
    constructor(address _vault, string storage name_, address _keeper) public {
        _name = name_;
